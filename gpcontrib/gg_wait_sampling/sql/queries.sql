...
SELECT count(*) = 1 as test FROM gg_wait_sampling_get_current_coordinator(NULL::INTEGER);
SELECT count(*) = 1 as test FROM gg_wait_sampling_get_current_segments(NULL::INTEGER);
